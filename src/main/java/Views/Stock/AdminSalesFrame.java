 ...
 * @author fsd
 */
public class AdminSalesFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSalesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
