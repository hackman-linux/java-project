 ...
 * @author fsd
 */
public class ViewSupplierListFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewUserListFrame
     */
    public ViewSupplierListFrame() {
        initComponents();
        form_update();
    }
    ...
    public void form_update(){
            ...
            if (db.Rst.isBeforeFirst()) {
                ...
                header.add("Supplier Email");
                header.add("Supplier Phone");
                ...
                JOptionPane.showMessageDialog(this, "Now There Is No Supplier");
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Supplier View LIst");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSupplierListFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
