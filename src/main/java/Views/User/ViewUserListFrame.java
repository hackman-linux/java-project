 ...
 * @author fsd
 */
public class ViewUserListFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewUserListFrame
     */
    public ViewUserListFrame() {
        initComponents();
        form_update();
    }
    ...
    public void form_update(){
            ...
            if (db.Rst.isBeforeFirst()) {
                ...
                JOptionPane.showMessageDialog(this, "Now There Is No User");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUserListFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
